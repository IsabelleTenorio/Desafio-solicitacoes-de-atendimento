...
import type { Categoria, FiltrosSolicitacoes, Prioridade, Status } from '../types';
  ...
  return (
    <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
      <Select
        ...
        opcoes={STATUS.map((status) => ({ value: status, label: rotuloStatus[status] }))}
      />
      ...
      <Select
        ...
        onChange={(evento) =>
          aoMudar({
            ...filtros,
            categoria: (evento.target.value || undefined) as Categoria | undefined,
            page: 1,
          })
        }
      ...
      <Select
        ...
        onChange={(evento) =>
          aoMudar({
            ...filtros,
            prioridade: (evento.target.value || undefined) as Prioridade | undefined,
            page: 1,
          })
        }
