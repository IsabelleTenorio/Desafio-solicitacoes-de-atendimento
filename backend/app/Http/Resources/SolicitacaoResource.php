...
class SolicitacaoResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            // Ajuda o frontend a desabilitar opções inválidas no select de status sem duplicar a tabela de transições no cliente.
            'proximos_status_permitidos' => array_map(
